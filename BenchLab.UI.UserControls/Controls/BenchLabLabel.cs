...
{
    public class BenchLabLabel : Label
    {
        private AddPunctuationValueConverter _addPunc;

        #region AddPaddingAfterPunctuation
        public static readonly DependencyProperty AddPaddingAfterPunctuationProperty = DependencyProperty.Register("AddPaddingAfterPunctuation", typeof(bool), typeof(BenchLabLabel), new FrameworkPropertyMetadata(true));
        ...
        public static readonly DependencyProperty EndPunctuationCharacterProperty = DependencyProperty.Register("EndPunctuationCharacter", typeof(char), typeof(BenchLabLabel), new FrameworkPropertyMetadata(':'));
        ...
        public static readonly DependencyProperty AddEndingPunctuationProperty = DependencyProperty.Register("AddEndingPunctuation", typeof(bool), typeof(BenchLabLabel), new FrameworkPropertyMetadata(true));
        ...
        public static readonly DependencyProperty PaddingLengthProperty = DependencyProperty.Register("PaddingLength", typeof(int), typeof(BenchLabLabel), new FrameworkPropertyMetadata(2));
