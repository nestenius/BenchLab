...
{
    public class BenchLabRichTextBox : System.Windows.Controls.RichTextBox
    {
        ...
        public BenchLabRichTextBox()
        {
            Loaded += RichTextBox_Loaded;
        }

        public BenchLabRichTextBox(System.Windows.Documents.FlowDocument document)
            : base(document){}
        ...
        public static readonly DependencyProperty TextProperty = DependencyProperty.Register("Text", typeof(string), typeof(BenchLabRichTextBox), new FrameworkPropertyMetadata(string.Empty, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnTextPropertyChanged));//, CoerceTextProperty, true, UpdateSourceTrigger.LostFocus
        public string Text
        {
        ...
        {
            BenchLabRichTextBox rtb = (BenchLabRichTextBox)d;
