...
{
    public interface IBenchLabObject : INotifyPropertyChanged
    {
        #region Properties
    ...
    [Serializable]
    [DataContract]
    public abstract class BenchLabObject : IBenchLabObject
    {
        #region Fields
        [DataMember]
        ...
        #region Constructor
        protected BenchLabObject() : this(false) { }
        protected BenchLabObject(bool propertyChangeEventDisabled)
            : base()
        {
        ...
        #region Overrides
        protected virtual bool Equals(BenchLabObject obj)
        {
            if (obj != null)
        ...
        {
            return this.Equals(obj as BenchLabObject);
        }
       ...
       // public Status PSStatus { get; set; }
        ...
        public static BenchLabObject Create(string name)
        {
            Type type = Type.GetType(name, false, true);
            if (type == null)
                return null;
            return Activator.CreateInstance(type) as BenchLabObject;
        }

        public static IBenchLabEntity CreateEntity(string name, int? id)
        {
            Type type = Type.GetType(name, false, true);
            if (type == null)
                return null;
            var entity = Activator.CreateInstance(type) as IBenchLabEntity;
            if (entity == null)
                return null;
            entity.ID = id;
            return entity;
