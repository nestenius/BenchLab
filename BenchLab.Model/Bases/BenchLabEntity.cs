...
{
    public interface IBenchLabEntity : IBenchLabObject
    {
        #region Properties
        int? ID { get; set; }
        ...
        #region Methods
        void PopulateObjectCommonData<T>(T targetObject) where T : IBenchLabEntity;
        
        TModel CreateModel<TModel, TPrimary>()
            where TModel : IBenchLabModel<TModel, TPrimary>, new()
            where TPrimary : IBenchLabEntity;

        IBenchLabEntity TrimToPSRid();
        void SetToNew();
        #endregion
    }

    [Serializable]
    [DataContract(Name="BenchLabEntity{0}")]
    public abstract class BenchLabEntity<T> : BenchLabObject, IBenchLabEntity, IDataErrorInfo  where T : BenchLabEntity<T>
    {
        #region Fields
        [DataMember]
       ...
       [Column("STATUS")]
        ...
        #region Constructors
        protected BenchLabEntity(bool propertyChangeEventDisabled) : base(propertyChangeEventDisabled) { }
        protected BenchLabEntity() : this(false)
        {
        ...
        public virtual IBenchLabEntity TrimToPSRid()
        {
            IBenchLabEntity entity = (IBenchLabEntity)Activator.CreateInstance<T>();
