...
{
    public interface IBenchLabObjectList<TPSObjectList, TPrimary> : IBenchLabObject
        where TPSObjectList : IBenchLabObjectList<TPSObjectList, TPrimary>
    {
        #region Properties
    ...
    public class BenchLabObjectList<TPSObjectList, TPrimary> : BenchLabObject, IBenchLabObjectList<TPSObjectList, TPrimary>
        where TPSObjectList : IBenchLabObjectList<TPSObjectList, TPrimary>
    {
        #region Fields
        [DataMember]
        ...
        #region Constructors
        protected BenchLabObjectList() : base() { }
        protected BenchLabObjectList(TPSObjectList itemList) : this(itemList, true) { }
        protected BenchLabObjectList(TPSObjectList itemList, bool useInternalListFlag)
            : base()
        {
        ...
        protected BenchLabObjectList(IList<TPrimary> internalList)
            : base()
        {
        ...
        public virtual bool IsObservableListDirty
        {
            get
            {
                ...
                {
                    foreach (IBenchLabObject item in this._observableList)
                    {
                        if (item != null)
                        {
        ...
        public virtual void ReplaceObservableListWithInternalList()
        {
            if (this._internalList != null)
            {
                ...
                IEnumerable<TPrimary> nonPendingDeleteItemQuery = from item in this._internalList
                                                                  let psObject = item as BenchLabObject
