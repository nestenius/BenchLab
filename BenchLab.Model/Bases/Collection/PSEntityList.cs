...
{
    public interface IBenchLabEntityList<T> : IBenchLabObject, IListPaging  where T : IBenchLabEntity
    {
        #region Properties
        ...
        bool Append(BenchLabEntityList<T> additionalList);
        void Clear();
        bool Remove(T item);
        ...
        TList GetDirtyEntities<TList>() where TList : IBenchLabEntityList<T>, new();
        ...
        IBenchLabEntityList<T> ReplicateFromObservableList();
        ...
        TList GetDirtyEntitiesFromObservableList<TList>() where TList : IBenchLabEntityList<T>, new();
        TList GetInvalidEntitiesFromObservableList<TList>() where TList : IBenchLabEntityList<T>, new();
        ...
        //    where TModelList : IBenchLabModelList<TModel, TList, T>, new()
        ...
        TList CreateACloneFromObservableList<TList>()
            where TList : IBenchLabEntityList<T>, new();
    ...
    /// </remarks>
    //[Serializable]
    [DataContract(Name = "BenchLabEntityList{0}")]
    public class BenchLabEntityList<T> : BenchLabObject, IBenchLabEntityList<T>  where T : IBenchLabEntity
    {
        #region Fields
        [DataMember]
        ...
        #region Constructors
        protected BenchLabEntityList() : base() { }
        protected BenchLabEntityList(List<T> internalList)
            : this()
        {
        ...
        public virtual bool Append(BenchLabEntityList<T> additionalList)
        {
        ...
        public virtual IBenchLabEntityList<T> ReplicateFromObservableList()
        {
            BenchLabEntityList<T> newList = new BenchLabEntityList<T>(this.GetReplicatedInternalListFromObservableList());
            return newList;
        }
        ...
        public virtual TList CreateACloneFromObservableList<TList>() where TList : IBenchLabEntityList<T>, new()
        {
        ...
        public override T CreateAClone<T>()
        {
            ...
            var psObject = result as BenchLabObject;
            if (psObject != null)
