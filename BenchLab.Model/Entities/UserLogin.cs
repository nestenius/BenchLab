...
namespace BenchLab.Model
{
    ...
    public class UserLogin : BenchLabEntity<UserLogin>
    {
        #region Fields
        ...
        {
            return !string.IsNullOrEmpty(this.LoginName) && !string.IsNullOrEmpty(this.LoginPassword) && !string.IsNullOrEmpty(this.ConfirmPassword) && string.Equals(this.LoginPassword, this.ConfirmPassword);
        }
        ...
        public override string this[string columnName]
        {
            get
            {
                ...
                {
                    return !this.ValidateCurrentPassword() ? "Invalid Password" : null;
                }

                if (columnName == "ConfirmPassword")
                {
                    return IsInEditMode ? !this.ValidateChangePassword() ? "Password not matched" : null : !this.ValidateNewPassword() ? "Password not matched" : null;
                }
