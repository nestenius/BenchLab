...
namespace BenchLab.View
{
    ...
    public partial class PrintView : UserControl
    {
        ...
        private void ShowReport()
        {
            ...
            {
                //todo: Assembly.GetExecutingAssembly().GetManifestResourceStream(Assembly.GetExecutingAssembly().GetManifestResourceNames().FirstOrDefault())
            var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(Assembly.GetExecutingAssembly()
                    .GetManifestResourceNames()
                    .FirstOrDefault(x => x.ToLower().Contains("Report.xaml".ToLower())));
